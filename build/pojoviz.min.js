...
(function (global){
function process(){var e,n=new dagre.Digraph,r=container.analyzer,o=r.stringify(),t=o.nodes,i=o.edges;_.forOwn(t,function(r,o){var t=o.match(/\S*?-(.*)/)[1];e={label:o,width:10*t.length},e.height=15*r.length+50,e.properties=r,r.forEach(function(n){e.width=Math.max(e.width,10*n.name.length)}),n.addNode(o,e)}),_.forOwn(i,function(e){e.forEach(function(e){n.hasNode(e.from)&&n.hasNode(e.to)&&n.addEdge(null,e.from,e.to)})});var a=dagre.layout().nodeSep(30).run(n),c=[],d=[],s={x:0,y:0},l={x:1/0,y:1/0},u={x:-1/0,y:-1/0},h=n.nodes().length;return a.eachNode(function(r,o){var t=o.x,i=o.y;e=n.node(r),e.x=t,e.y=i,e.predecessors=n.predecessors(r),e.successors=n.successors(r),c.push(e);var a=t-e.width/2,d=i-e.height/2,h=t+e.width/2,f=i+e.height/2;s.x+=t,s.y+=i,l.x=Math.min(l.x,a),l.y=Math.min(l.y,d),u.x=Math.max(u.x,h),u.y=Math.max(u.y,f)}),s.x/=h||1,s.y/=h||1,_(i).forOwn(function(e){e.forEach(function(e){n.hasNode(e.from)&&n.hasNode(e.to)&&d.push(e)})}),{edges:d,nodes:c,center:s,mn:l,mx:u}}function render(){var e;container!==oldContainer&&(utils.notification("processing "+container.global),oldRenderer&&oldRenderer.clean(),renderer.clean(),setTimeout(function(){container.preRender(),console.log("process & render start: ",new Date),console.time("process"),e=process(),console.timeEnd("process"),utils.notification("rendering "+container.global),console.time("render"),renderer.render(e),console.timeEnd("render"),utils.notification("complete!")},0))}var _=_dereq_("lodash"),Q=_dereq_("q"),dagre="undefined"!=typeof window?window.dagre:"undefined"!=typeof global?global.dagre:null,utils=_dereq_("./util/"),ObjectHashes=_dereq_("./ObjectHashes");Q.longStackSupport=!0;var container,oldContainer,oldRenderer,renderer,pojoviz;pojoviz={renderers:{},addRenderers:function(e){_.merge(pojoviz.renderers,e)},nullifyContainer:function(){oldContainer=container,container=null},getContainer:function(){return container},setContainer:function(e,n){return oldContainer=container,container=ObjectHashes[e],container?container.src=n.src:container=ObjectHashes.createNew(e,n),container.init()},setRenderer:function(e){oldRenderer=renderer,renderer=pojoviz.renderers[e]},getRenderer:function(){return renderer},render:render,ObjectHashes:_dereq_("./ObjectHashes"),ObjectAnalyzer:_dereq_("./ObjectAnalyzer"),analyzer:{GenericAnalyzer:_dereq_("./analyzer/GenericAnalyzer")},utils:_dereq_("./util"),userVariables:[]},document.addEventListener("property-click",function(e){var n=e.detail;pojoviz.getContainer().showSearch(n.name,n.property)}),module.exports=pojoviz;
//# sourceMappingURL=pojoviz.map.json
