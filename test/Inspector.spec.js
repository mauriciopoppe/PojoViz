...
const Inspector = require('../src/analyzer/Inspector')
const utils = require('../src/util/')

const BuiltIn = require('../src/analyzer/BuiltIn')
const PObject = require('../src/analyzer/Object')

describe('Inspector', function () {
  describe('with predefined instances', function () {
    it('inspects the basic objects', function (done) {
      const inspector = new PObject()
      inspector.init()
        .then(function () {
    ...
    it('inspects the builtIn objects', function (done) {
      ...
      let length = inspector.getItems().length * 2
